...
const Banner = () => {
    ...
    return (
        <div className='relative'>
            ...
            <h2 data-aos="fade-down" data-aos-duration="2000" className=" text-lg lg:text-5xl font-bold absolute top-4 lg:top-24 text-orange-600 left-1 md:left-10 lg:left-52">... Create more Happiness ...</h2>
            <h2 data-aos="fade-down" data-aos-duration="2000" className=" text-lg lg:text-5xl font-bold absolute top-4 lg:top-24 text-orange-600 right-1 md:right-10 lg:right-52">... with our drinks ...</h2>
